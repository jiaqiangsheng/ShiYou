...
import com.lxx.chiocemorepicture.adapter.AlbumGridViewAdapter;
import com.lxx.chiocemorepicture.util.AlbumHelper;
import com.lxx.chiocemorepicture.util.Bimp;
import com.lxx.chiocemorepicture.util.ImageBucket;
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (isChecked) {
							...
							Bimp.path.add(dataList.get(position).getImagePath());
							okButton.setText(Res.getString("finish") + "(" + Bimp.tempSelectBitmap.size()
									+ "/" + PublicWay.num + ")");
						} else {
