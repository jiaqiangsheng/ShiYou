...
public class BlackListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hhy_fragment_black_list,null);
        //初始化xUtils
        initXUtils();
        initView(view);
        initData();
    ...
    private void setAdapter() {
        mAdapter = new Tianjia_PingBi_AccountAdapter(mList,getActivity(),"blacklist");
    ...
    private void selectDataBase() {
        ...
        params.addQueryStringParameter("selectblack", "selectblack");
    ...
    private void initView(View view) {
        ...
        mImageView = (ImageView) view.findViewById(R.id.hhy_black_list_image);
        mRelativeLayout = (RelativeLayout) view.findViewById(R.id.hhy_black_list_relative);
        mListView = (ListView) view.findViewById(R.id.hhy_blacklist_listview);
        mRelativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //跳转至页面
                mIntent = new Intent(getActivity(), PinBiAddActivity.class);
                mIntent.putExtra("biaozhi","blacklist");
