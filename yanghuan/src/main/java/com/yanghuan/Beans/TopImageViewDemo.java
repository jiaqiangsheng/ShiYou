 ...
 */
public class TopImageViewDemo extends ImageView {
    public TopImageViewDemo(Context context) {
        super(context);
    }
    public TopImageViewDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TopImageViewDemo(Context context, AttributeSet attrs, int defStyle) {
